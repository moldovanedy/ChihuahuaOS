...
public static class RuntimeImports
{
    ...
    internal static void RhReRegisterForFinalize(object obj)
    {
        if (!_RhReRegisterForFinalize(obj))
            ThrowHelpers.ThrowInvalidProgramException();
    }
    ...
    internal static extern bool RhRegisterForFullGCNotification(int maxGenerationThreshold,
    ...
    internal static
        ...
        unsafe
#endif
        object? RhHandleGet(IntPtr handle)
    {
#if DEBUG
    ...
    internal static extern unsafe IntPtr RhResolveDispatchOnType(MethodTable* instanceType, MethodTable* interfaceType,
        ushort slot);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [RuntimeImport(RuntimeLibrary, "RhResolveStaticDispatchOnType")]
    internal static extern unsafe IntPtr RhResolveStaticDispatchOnType(MethodTable* instanceType,
        MethodTable* interfaceType, ushort slot, MethodTable** pGenericContext);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [RuntimeImport(RuntimeLibrary, "RhResolveDynamicInterfaceCastableDispatchOnType")]
    internal static extern unsafe IntPtr RhResolveDynamicInterfaceCastableDispatchOnType(MethodTable* instanceType,
        MethodTable* interfaceType, ushort slot, MethodTable** pGenericContext);
    ...
    internal static extern unsafe bool RhRegisterRefCountedHandleCallback(IntPtr pCalloutMethod,
        MethodTable* pTypeFilter);

    [MethodImpl(MethodImplOptions.InternalCall)]
    [RuntimeImport(RuntimeLibrary, "RhUnregisterRefCountedHandleCallback")]
    internal static extern unsafe void RhUnregisterRefCountedHandleCallback(IntPtr pCalloutMethod,
        MethodTable* pTypeFilter);
    ...
    internal static extern ulong RhCurrentOSThreadId();

    [MethodImpl(MethodImplOptions.InternalCall)]
    [RuntimeImport(RuntimeLibrary, "RhGetDefaultStackSize")]
    internal static extern IntPtr RhGetDefaultStackSize();
    ...
    internal static extern IntPtr RhFindMethodStartAddress(IntPtr codeAddr);
